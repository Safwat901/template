...
const Footer = () => {
    return (
        <div>
            <footer class="text-center lg:text-left bg-gray-100 text-gray-600 overflow-hidden">
                <div className=' container mx-auto px-14   space-x-4   mt-10'>
                    ...
                    <div class="text-center p-6 bg-gray-200">
                        ...
                        <a class="text-gray-600 font-semibold" href="https://tailwind-elements.com/">BitBot Lab</a>
                    </div>
                </div>
            </footer>
        </div>

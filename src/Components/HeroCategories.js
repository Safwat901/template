    ...
    return (
        <div className='container mx-auto px-4  flex flex-col space-x-4 lg:flex-row '>
            ...
            <div className=' flex flex-col space-y-4 w-4/5 justify-start  mr-5'>
                ...
                {/* ...............................Carousal..............................  */}
                {/*,,,,,,,,,,,,,,,, Hero section ............. */}
                <div className='bg-gray-500 max-w-[1400px] h-[400px] relative group '>
                    <div style={{ backgroundImage: `url(${slides[currentIndex].url})` }} className='w-full h-full bg-center bg-cover sm:w-full sm:h-full md:w-full md:h-full '>

                        {/* ...............Button and contents............... */}
                        <div>
                            <div className='absolute top-[30%] ml-20'>
                                <p className='font-bold text-green-600'>Fresh Fruit</p>
                                <p className='font-extrabold text-2xl'>Vegetable 100% organic</p>
                                <p className=' font-thin'>Free pickup and delevery available</p>
                            </div>
                            <div>
                                <div className=' absolute top-[70%] ml-40 '>
                                    <div type="button" className=" inline-flex rounded justify-center bg-green-600 cursor-pointer   px-4 py-2 text-sm font-medium bg text-gray-700 shadow-sm  focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-100" id="menu-button" aria-expanded="true" aria-haspopup="true">
                        ...
                        {/* ...............Button and contents end............... */}

                    </div>

                    <div className='hidden group-hover:block absolute top-[50%] left-5 translate-x-1 cursor-pointer rounded-full '>
                        <ChevronLeftIcon onClick={handleLeft} />

                    </div>

                    <div className='hidden group-hover:block absolute top-[50%] right-5 translate-x-1 cursor-pointer rounded-full '>
                        <ChevronRightIcon onClick={handleRight} />
